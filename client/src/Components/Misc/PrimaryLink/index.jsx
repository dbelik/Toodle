...
export default function PrimaryLink({ children, href }) {
    return (
        <StyledPrimaryLink className="btn-primary border-none outline-none block relative py-3 px-6 rounded-3xl bg-primary color-primary-content overflow-hidden" href={href}>
